<?php 
	...
	{
		$GLOBALS['err_msg'] = $adminObj -> editWhatsNew();
	}
      ...
      <div id="breadcrumbs">
        ...
        <div class="breadcrumb-button">
          <span class="breadcrumb-label">
            <i class="icon-dashboard"></i> Whats New?
          </span>
          <span class="breadcrumb-arrow"><span></span></span>
        </div>
      </div>
	 ...
	 <div class="row">
            <div class="col-lg-6">
              ...
              <ul class="padded separate-sections">
                ...
                <textarea name="whatsnew" class="ckeditor" id="whatsnew"><?php echo $info['what_new'];?></textarea></li>
              </ul>
